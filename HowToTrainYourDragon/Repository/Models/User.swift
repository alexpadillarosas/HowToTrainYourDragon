...
struct User : Codable {
    ...
    var username : String?  //optional as the user will enter it later
    var firstname : String? //optional as the user will enter it later
    var lastname : String?  //optional as the user will enter it later
    var dob : Date?  //optional as the user will enter it later
    var memberSince : Date?
    var phone: String?  //optional as the user will enter it later
